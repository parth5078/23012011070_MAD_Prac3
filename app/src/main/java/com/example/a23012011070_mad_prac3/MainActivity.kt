package com.example.a23012011070_mad_prac3
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.loginbutton).setOnClickListener {
            Intent(this, RegisterActivity::class.java).putExtra("username", "username")
                .putExtra("password", "password").putExtra("phone no", "phone no")
